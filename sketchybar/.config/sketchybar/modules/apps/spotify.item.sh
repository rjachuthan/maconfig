...
sketchybar --add       event           spotify_change $SPOTIFY_EVENT        \
           ...
           --set       spotify.anchor  script="$MODULE_DIR/apps/spotify.plugin.sh" \
           ...
           --set       spotify.cover   script="$MODULE_DIR/apps/spotify.plugin.sh" \
                                       label.drawing=off                    \
                                       icon.drawing=off                     \
                                       padding_left=12                      \
                                       padding_right=10                     \
           ...
           --set       spotify.next    icon=$SPOTIFY_NEXT                   \
                                       icon.padding_left=5                  \
                                       icon.padding_right=5                 \
                                       icon.color=$BLACK                    \
                                       label.drawing=off                    \
           ...
           --set       spotify.repeat  icon=$SPOTIFY_REPEAT                 \
                                       icon.highlight_color=$GREY           \
                                       icon.padding_left=5                  \
