...
--- THE <leader> MAP
--- ===========================================================================
--- READ THIS FILE to learn what this config can do. It is the single place
--- where the shape of the leader key is decided.
---
--- HOW THIS WORKS (and why it isn't one giant keymap table)
---
...
---
--- TO ADD A BINDING:  put it in the plugin's `keys` spec, under an existing
---                    prefix below. which-key picks it up automatically.
--- TO ADD A GROUP:    add a row to M.groups here.
--- TO MOVE A GROUP:   change the prefix here AND in the specs that use it.
---
--- ---------------------------------------------------------------------------
