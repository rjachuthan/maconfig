...
-- ============================================================================
-- Clear background highlights so Neovim inherits the terminal's background
-- color instead of drawing its own. This must run after every colorscheme load.
-- ============================================================================
...
-- Apply immediately since ColorScheme already fired before this file loaded
